...
%                 pause(.1)
    ...
    save(['/ifs/data/buzsakilab/popDecoding_Results/' sessionInfo.FileName '.positionDecodingMaxCorr_binned_box.' num2str(sort(spikes.UID(ensemble)),'%0.3d') '.popinfo.mat'],'positionDecodingMaxCorr_binned_box_mean')
end
% end
