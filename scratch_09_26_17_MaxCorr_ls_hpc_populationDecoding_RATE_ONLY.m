...
for wind = smoothingRange
        ...
        fits = cell2struct({yfit_rate,septalResponse_test},{'rate','response'},2);
        struct.tau = wind;
...
save([RECORDING '/' sessionInfo.FileName '_rate_decoding_cell_' num2str(septalCell) '.mat'],'lsRateDecodingHPC_POP_MaxCorr')
