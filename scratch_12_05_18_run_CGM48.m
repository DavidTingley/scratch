...
remove = [1:72 642:655 1187:2000 4100:4150 4965:5282];
% 1860:2419
...
% save(['/home/david/Dropbox/Documents/pubs/inProgress/glucose/data/revision/dvSweep/' num2str(threshold,'%06.f') '_CGM48.mat'],'-v7.3')
save(['/home/david/Dropbox/Documents/pubs/inProgress/glucose/data/revision/CGM48.mat'],'-v7.3')
% end
