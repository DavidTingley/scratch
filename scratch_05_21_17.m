...
% generateSessionInfo('DT7',0);
spikes = bz_GetSpikes('getwaveforms',true,'region','ls','forcereload',true);
if ~isempty(spikes)
...
save([spikes.sessionName '.ls_RipplePhaseModulation.cellinfo.mat'],'spikes')
end
end
end
cd ..
