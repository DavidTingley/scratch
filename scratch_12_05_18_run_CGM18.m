...
%                 stimTimes{i} = stimTimes_s; clear stimTimes_s
                ...
                load([d(i).name '.responseMagnitudes.mat'],'resp*')
...
%                 lfp.samplingRate = 1250;
                ...
                load([d(i).name '.specSlope.mat'],'specslope_singleRec')
                specslope{i} = specslope_singleRec; clear specslope_singleRec;
            end
...
save('C:\Users\SB13FLLT001\Dropbox\Documents\pubs\inProgress\glucose\data\stim\_cgm18.mat','-v7.3')
% whos
% 
% for i=-60:60
