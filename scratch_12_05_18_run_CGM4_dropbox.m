clear all
cd C:\Users\SB13FLLT001\Dropbox\Documents\pubs\inProgress\Hormones
% 
...
cd(['C:\Users\SB13FLLT001\Dropbox\Documents\pubs\inProgress\glucose\' animal])
...
load('CGM4.mat','theta*','absTime','rt','at','zt*','spec*','stim*','isig*','d','ripples','SleepState')
...
hourHz = 1/(60*60);
minuteHz = 1/(60);
% [b a] = butter(3,[ / nyquist],'high');
isa = fillmissing((isig_levels),'nearest');
isa = highpass(isa,dayHz,nyquist*2);
...
idx = [1:3613];
idx = [61:1500 2200:2500 2880:length(count)];
...
%  save('C:\Users\SB13FLLT001\Dropbox\Documents\pubs\inProgress\Hormones\data\CGM4.mat','-v7.3')
