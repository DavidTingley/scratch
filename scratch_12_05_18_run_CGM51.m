...
cd /mnt/nyuShare/Homes/dwt244/glucoseRev/LS_dreadd/CGM51
...
remove = [1:100 550:847  3600:3950 4450:4545];
% 1860:2419
...
[b a] = butter(4,[ dayHz/3 / nyquist],'high');
...
% count(count>250)=nan;
% count(isnan(isig_levels))=nan;


% save('C:\Users\SB13FLLT001\Dropbox\Documents\pubs\inProgress\glucose\data\revision\bruce.mat','-v7.3')
save('/home/david/Dropbox/Documents/pubs/inProgress/glucose/data/revision/CGM51.mat','-v7.3')
