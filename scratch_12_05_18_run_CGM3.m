...
%% DAYLIGHT SAVINGS FIX HERE

isig_levels(1:2500) = circshift(isig_levels(1:2500),-12);
isig_levels(2500-12:2500)=nan;
%%
...
for i=1:length(d)
    ...
    %                 movement{i} = sum(abs(diffs)); clear diffs   
            ...
            if ~exist([d(i).name '.thetaResid.mat'])
                ...
                theta_resid = makeLength(fastrms(r,30),round(length(lfp.data)./1250));
...
% 3/03 recording has bad end... drifted out of CA1 @870 min
remove = [1:100, 660:810, 1380:2274, 2800:2865, 3310:3505 3680:3705];
% 1860:2419
...
imagesc(av)
 ...
 save('C:\Users\SB13FLLT001\Dropbox\Documents\pubs\inProgress\glucose\data\_CGM3.mat','-v7.3')
% whos
% 
% 
% 
