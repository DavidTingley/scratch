...
%     states(i) = nansum(state(ind)==3)./length(ind);
    ...
    ind = find(InIntervals(stimTimes_logFile,[absTime(i)-1.15741277113557e-05*60*5 absTime(i)]));
...
save('/home/david/Dropbox/Documents/pubs/inProgress/glucose/data/cgm19.mat','-v7.3')
% whos
% 
% for i=-60:60
