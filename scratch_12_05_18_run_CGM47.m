...
cd /mnt/nyuShare/Homes/dwt244/glucoseRev/LS_dreadd/CGM47

animal = 'CGM47'; 
addpath(genpath(pwd))
read_CGM_data_DEXCOM_REV
%% daylight savings fix
isig_levels(1:563) = circshift(isig_levels(1:563),12);
%%
...
save('/home/david/Dropbox/Documents/pubs/inProgress/glucose/data/revision/CGM47.mat','-v7.3')
